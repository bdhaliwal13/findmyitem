...
public class Main {
	...
	public static void main(String[] args) {
		...
		//advantage is if we wanted to expand on this and provide some flexibility, You don't have to specify all the paramters that otherwise would be required when creating a new Valuable item.
