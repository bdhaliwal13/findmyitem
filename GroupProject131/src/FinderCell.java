...
public class FinderCell { // tanner
	...
	public int getGPSLoc(ValuableItem someItem) {
		...
		System.out.print(
				"The item with tag: " + someItem.getTag() + "was found at GPS Location: " + someItem.getGpsLocation());
	...
	public void findPhone(ValuableItem item) {
		...
		timer.schedule(new TimerTask() {
			@Override
			public void run() {
				System.out.println("The phone with the tag" + item.getTag() + "was found at the location "
						+ item.getGpsLocation());
			}
		}, 0, 1000 * 60 * minutes);
	}
