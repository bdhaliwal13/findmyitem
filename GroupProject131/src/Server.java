     ...
     /*  FinderCell finder = new FinderCell();
        ...
        TimerTask myTask = new TimerTask() {
            ...
            public void run() {
                ...
                System.out.println("The item with tag: " + lost.getTag() + " was found at GPS Location: " + lost.getGpsLocation());   //Stole Sytem.out.println stuff from FinderCell
